...
//        id = 1;
//        providerRepository.save(new Provider(1, "a", "2023-09-15", null));
//
//        userRepository.save(new User("123", "asd", "a@a.com", "1977-09-15", "Tehran", 10000L, List.of()));
//        userRepository.save(new User("456", "asd", "a@a.com", "1977-09-15", "Tehran", 10000L, List.of()));
//        userRepository.save(new User("789", "asd", "a@a.com", "1977-09-15", "Tehran", 10000L, List.of()));
//        userRepository.save(new User("012", "asd", "a@a.com", "1977-09-15", "Tehran", 10000L, List.of()));
//
